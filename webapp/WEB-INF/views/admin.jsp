...
<body>
	...
	<footer class="w3-container w3-padding-64 w3-center w3-black w3-xlarge">
		...
		<a href="#"><i class="fa fa-linkedin"></i></a> <a href=#></a><span
			class="glyphicon glyphicon-phone-alt"></span> <a href="aboutus">ABOUT
			US</a>

		<p class="w3-medium">
			Powered by <a href="aboutus" target="_blank">saranya</a>
		</p>
	</footer>
