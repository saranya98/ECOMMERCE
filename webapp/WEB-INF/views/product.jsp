...
<body>
	...
	<form:form action="AddProduct" modelAttribute="product"
		...
		<table align="center" cellspacing="2">
			...
			<tr>
			<td>Image <form:input type="file" path="pimage"/></td>
			</tr>
			
			<tr>
				<td>Product Desc</td>
				<td><form:input type="text" path="productDesc"
						required="required" /></td>
			</tr>
			<tr>
				<td>Product Quantity</td>
				<td><form:input type="text" path="productQuantity"
						required="required" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td>Product Price</td>
				<td><form:input type="text" path="productPrice"
						required="required" /></td>
			</tr>
			<br>
			<tr>
...
<th>Operation</th>
			...
			<c:forEach items="${productList}" var="product">
				<tr bgcolor="">
					...
					<td><img src="<url value="resources/images${product.productId}.jpg"/>"
					style="height:200px;width:60% "alt="errror"/></a></td>
